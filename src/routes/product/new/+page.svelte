...
<form class="mt-20 w-full items-center justify-center" method="post" action="?/save" use:enhance={handleSubmit}>
  <div class="mx-auto w-full rounded-lg bg-white p-4 shadow-lg">
    ...
    <div class="mb-2">
      ...
      <textarea class="h-20 w-full border border-gray-400" bind:value={product.feature} />
    </div>

    <div class="mb-2">
      <p class="font-bold">제품 메뉴얼</p>
      <textarea class="h-20 w-full border border-gray-400" bind:value={product.manual} />
    </div>
